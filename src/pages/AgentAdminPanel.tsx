    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-600">Agent Admin Panel</span>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-sm">
        <div className="flex items-center gap-2">
          <Shield className="h-6 w-6 text-primary" />
          <h1 className="text-xl font-semibold text-gray-900">Agent Admin Panel</h1>
        </div>
      ...
      <main className="p-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Agent Admin Dashboard</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Direct access to all admin features without authentication - Select a module to manage system functions
            </p>
          </div>
